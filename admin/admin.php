	...
	class ISC_Admin extends ISC_Class {
		...
		public function renderfield_sources_display_type() {
			...
			<div id="display_types_block">
				...
				<p>
				<?php
				echo __( 'If you don’t want to use any of these methods, you can still place the image source list manually as described <a href="http://webgilde.com/en/image-source-control/image-sources-frontend/" title="external link" target="_blank">here</a>', 'image-source-control-isc' );
				?>
				</p>
			</div>
			</td></tr></tbody></table>
