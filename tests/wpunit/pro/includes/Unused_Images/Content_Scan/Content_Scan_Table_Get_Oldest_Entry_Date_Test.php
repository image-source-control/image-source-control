...
/**
 * Testing the Content_Scan_Table::get_oldest_entry_date() and get_oldest_entry_date_by_post_id() methods
 */
class Content_Scan_Table_Get_Oldest_Entry_Date_Test extends WPTestCase {
	...
	public function test_get_oldest_entry_date_returns_null_when_empty() {
		$timestamp = $this->content_scan_table->get_oldest_entry_date();
		$string    = $this->content_scan_table->get_oldest_entry_date( 'string' );
	...
	public function test_get_oldest_entry_date_returns_timestamp_by_default() {
		...
		$result = $this->content_scan_table->get_oldest_entry_date();
	...
	public function test_get_oldest_entry_date_returns_string_when_requested() {
		...
		$result = $this->content_scan_table->get_oldest_entry_date( 'string' );
	...
	public function test_get_oldest_entry_date_finds_oldest_among_multiple() {
		...
		$oldest_timestamp = $this->content_scan_table->get_oldest_entry_date();
	...
	public function test_get_oldest_entry_date_caching() {
		...
		$first_call = $this->content_scan_table->get_oldest_entry_date();

		// Second call - should use cache
		$second_call = $this->content_scan_table->get_oldest_entry_date();
		...
		$this->content_scan_table->insert_or_update(
			...
			$this->attachment_id_2,
			'content',
			$this->content_scan_table->get_last_checked( time() - 7200 )
		);

		// Third call - should still return cached value (not the new older entry)
		$third_call = $this->content_scan_table->get_oldest_entry_date();
	...
	public function test_cache_is_reset_after_clear_all() {
		...
		$before_clear = $this->content_scan_table->get_oldest_entry_date();
		...
		$after_clear = $this->content_scan_table->get_oldest_entry_date();
	...
	public function test_get_oldest_entry_date_by_post_id_returns_null_when_empty() {
		$result = $this->content_scan_table->get_oldest_entry_date_by_post_id( $this->post_id_1 );
	...
	public function test_get_oldest_entry_date_by_post_id_with_invalid_id() {
		$result_zero     = $this->content_scan_table->get_oldest_entry_date_by_post_id( 0 );
		$result_negative = $this->content_scan_table->get_oldest_entry_date_by_post_id( - 1 );
	...
	public function test_get_oldest_entry_date_by_post_id_returns_string() {
		...
		$result = $this->content_scan_table->get_oldest_entry_date_by_post_id( $this->post_id_1, 'string' );
	...
	public function test_get_oldest_entry_date_by_post_id_finds_oldest_for_post() {
		...
		$oldest_post_1 = $this->content_scan_table->get_oldest_entry_date_by_post_id( $this->post_id_1 );
		$oldest_post_2 = $this->content_scan_table->get_oldest_entry_date_by_post_id( $this->post_id_2 );
	...
	public function test_get_oldest_entry_date_by_post_id_is_not_cached() {
		...
		$first_call = $this->content_scan_table->get_oldest_entry_date_by_post_id( $this->post_id_1 );
		...
		$second_call = $this->content_scan_table->get_oldest_entry_date_by_post_id( $this->post_id_1 );
	...
	public function test_get_oldest_entry_date_by_post_id_isolates_by_post() {
		...
		$this->content_scan_table->insert_or_update(
			...
			$this->attachment_id_1,
			'content',
			$this->content_scan_table->get_last_checked( $current_time - 86400 ) // 24 hours ago
		);
		...
		$this->content_scan_table->insert_or_update(
			...
			$this->attachment_id_2,
			'content',
			$this->content_scan_table->get_last_checked( $current_time - 3600 ) // 1 hour ago
		);
