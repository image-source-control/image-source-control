...
/**
 * Testing the ISC\Pro\Indexer\Content_Scan_Table class
 */
class Content_Scan_Table_Test extends WPTestCase {
	...
	public function test_insert_or_update_creates_new_entry() {
		$result = $this->content_scan_table->insert_or_update(
			$this->post_id,
			$this->attachment_id,
			'content'
		);
	...
	public function test_insert_or_update_updates_existing_entry() {
		...
		$first_id = $this->content_scan_table->insert_or_update(
			$this->post_id,
			$this->attachment_id,
			'content'
		);
		...
		$second_id = $this->content_scan_table->insert_or_update(
			$this->post_id,
			$this->attachment_id,
			'content'
		);
		...
		$updated_entries = $this->content_scan_table->get_by_post_id( $this->post_id );
	...
	public function test_delete_by_post_id() {
		...
		$result = $this->content_scan_table->delete_by_post_id( $this->post_id );
	...
	public function test_delete_by_post_id_with_position() {
		...
		$result = $this->content_scan_table->delete_by_post_id( $this->post_id, 'content' );
	...
	public function test_delete_by_attachment_id() {
		...
		$result = $this->content_scan_table->delete_by_attachment_id( $this->attachment_id );
	...
	public function test_bulk_insert_or_update() {
		...
		$result = $this->content_scan_table->bulk_insert_or_update( $entries );
	...
	public function test_count_occurrences_by_post_id() {
		...
		$count = $this->content_scan_table->count_occurrences_by_post_id( $this->post_id );
	...
	public function test_get_global_stats_since() {
		...
		$stats = $this->content_scan_table->get_global_stats_since( $timestamp );
	...
	public function test_find_orphaned_entries() {
		...
		$orphaned = $this->content_scan_table->find_orphaned_entries();
	...
	public function test_delete_orphaned_entries() {
		...
		$deleted = $this->content_scan_table->delete_orphaned_entries();
	...
	public function test_delete_invalid_entries() {
		...
		$deleted = $this->content_scan_table->delete_invalid_entries();
	...
	public function test_clear_all() {
		...
		$result = $this->content_scan_table->clear_all();
	...
	public function test_is_valid_position() {
		$this->assertTrue( $this->content_scan_table->is_valid_position( 'content' ) );
		$this->assertTrue( $this->content_scan_table->is_valid_position( 'thumbnail' ) );
		$this->assertTrue( $this->content_scan_table->is_valid_position( 'head' ) );
		$this->assertTrue( $this->content_scan_table->is_valid_position( 'body' ) );
		$this->assertFalse( $this->content_scan_table->is_valid_position( 'invalid' ) );
	}
	...
	public function test_get_default_position() {
		$this->assertEquals( 'content', $this->content_scan_table->get_default_position() );
	}
	...
	public function test_update_last_checked() {
		...
		$result = $this->content_scan_table->update_last_checked(
			$this->post_id,
			$this->attachment_id
		);
