...
class ISC_Model {
	...
	public static function clear_single_post_images_index( $post_id ) {
		ISC_Log::log( 'function moved. \ISC\Image_Sources\Post_Meta::clear_single_post_images_index' );
	...
	public static function clear_post_images_index() {
		ISC_Log::log( 'function moved. \ISC\Image_Sources\Post_Meta::clear_post_images_index' );

		return Post_Meta::clear_post_images_index();
	}
	...
	public static function clear_image_posts_index() {
		ISC_Log::log( 'function moved. \ISC\Image_Sources\Post_Meta::clear_image_posts_index' );

		return Post_Meta::clear_image_posts_index();
	}
